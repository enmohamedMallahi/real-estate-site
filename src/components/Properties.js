...
const Properties = ({ properties }) => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 md:gap-8 p-4">
      {properties.map((property) => (

        <div className="relative bg-white flex flex-col md:flex-row gap-2 border rounded-lg overflow-hidden">
